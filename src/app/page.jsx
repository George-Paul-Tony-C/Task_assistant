          ...
          <div className="w-[35%] h-full">
            <div className="w-full h-full bg-neutral-900 rounded-md p-3">
              ...
              <div className="p-2 w-full h-24 flex justify-evenly">
                ...
                <div className="w-[70%] h-full bg-neutral-800 ring-2 ring-neutral-700 p-3 flex justify-evenly">
                  <div>
                    <div className="text-xl">11:00 AM - 12:00 PM</div>
                    <div className="text-lg text-gray-400">Meeting with UX Team</div>
                  </div>
                  <div>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-12 stroke-neutral-500">
